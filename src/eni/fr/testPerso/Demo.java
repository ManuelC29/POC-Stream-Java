...
public class Demo {
	...
	public static void main(String[] args) {
		...
		.filter(v->v.getMontantCmd()>10 && v.getMontantCmd()<50)	//(un peut Équivalent au where en sql) je filtre que ceux qui ont payés plus de 10€ mais quand même moins de 50€
